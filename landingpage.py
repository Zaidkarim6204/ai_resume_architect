...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --accent-dark-blue: #0b3d6e; /* Shared accent */
            --accent-yellow: #ffb800; /* Shared accent */
            --light-border: #eaeaea;
            --dark-border: #eee;
        ...
        * {
        ...
        /* Semantic Navigation with Theme Toggle */
        .navbar {
            position: sticky;
            top: 0;
            z-index: 100;
        ...
        /* Right Column (Intricate Layered Visuals) */
        .right-content {
            flex: 1;
            position: relative;
            min-height: 750px;
        ...
        @media (max-width: 1024px) {
            ...
            .nav-links { gap: 16px; }
            .hero-section, .numbered-grid, .testimonial-grid, .grid-section {
                flex-direction: column;
            ...
            .card-1, .card-2, .cl-stack-container, .cl-stack-container {
                right: 5%;
            }
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="https://airesumebuilder-g3x89b2t4vqnsdxvisf26a.streamlit.app/" class="cta-button" target="_blank">Launch App →</a>
        </div>
    </nav>
    ...
    <main class="hero-section">
        ...
        <div class="left-content">
            ...
            <p class="subtitle">Our Resume Builder creates Intricate, classy, and ATS-friendly resumes in minutes. Build a new resume or improve an existing one with Intricate analysis and smart AI suggestions.</p>

            <div class="cta-section">
                <a href="#howitworks" class="cta-button">See How it Works</a>
            </div>
        </div>
    ...
    <section id="features">
        ...
        <div class="grid-section">
            ...
            <div class="tool-card">
                ...
                <h3>PDF & Markdown Export</h3>
                <p>Download your resume in clean PDF or editable Markdown. No watermarks, no limits.</p>
        ...
        <div class="testimonial-grid">
            ...
            <div class="testimonial-card">
                ...
                <div class="user-info">
                    ...
                    <div class="user-details">
                        <h4>Zaid Karim</h4>
                        <p>CS Student → SWE Intern, Amazon</p>
                    </div>
                </div>
            </div>
        </div>
