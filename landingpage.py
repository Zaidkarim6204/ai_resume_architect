...
# 1. Setup the page to be as wide as possible
st.set_page_config(page_title="ZNA - AI Resume Builder", layout="wide", initial_sidebar_state="collapsed")

# 2. Hack the Streamlit CSS to remove ALL default padding, margins, and headers
st.markdown("""
    <style>
        ...
        /* Remove all padding so the HTML touches the edges of the screen */
        .block-container {
...
# 3. Paste your exact HTML code here inside the triple quotes
html_content = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 1024px) {
            ...
            .card-1, .card-2, .cl-stack-container {
                right: 5%;
            }
        }
    </style>
    ...
    <main class="hero-section">
            ...
            <div class="features">
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        ...
                        <p>Format your resume so it's easy for recruiters to find in searches.</p>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        <h3>Job matching</h3>
                        <p>Instantly edit any resume to match a job description using AI.</p>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        ...
                        <p>Build, update, edit, and export as many resumes as you need — free.</p>
                    </div>
                </div>

                <div class="feature-item">
                    <i class="fab fa-linkedin feature-icon" style="color: #0077b5;"></i>
                    <div class="feature-text">
                        <h3>Direct apply through LinkedIn</h3>
                        <p>Seamlessly submit your tailored resume directly to LinkedIn job postings.</p>
                    </div>
                </div>
                ...
                <div class="feature-item">
                    ...
                    <div class="feature-text">
                        <h3>Automatic generation of cover letter</h3>
                        <p>Generate a matching cover letter instantly tailored to the job description.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="right-content">
            ...
            <div class="resume-mockup">
                ...
                <ul>
                    <li>Managed a comprehensive cross functional marketing campaign overseeing a team of 10 professionals...</li>
                </ul>
            </div>

            <div class="floating-card card-1">
                <div class="card-header">
                    <i class="fas fa-file-contract"></i> Resume Analysis and Matching
                </div>
            ...
            <div class="floating-card card-2">
                ...
                <div class="ai-textbox">
                    Increased website traffic by XX% through a targeted content marketing campaign over Y months, enhancing brand visibility and engagement.
                </div>
            </div>
...
# 4. Inject the HTML into the Streamlit app
